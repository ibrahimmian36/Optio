...
Phase 1: scan infrastructure and kernel-throughput measurement. No
certificate is published yet. See docs/ERDOS364_PLAN.md for the program and
docs/ERDOS364_PHASE0.md for the due-diligence memo.
